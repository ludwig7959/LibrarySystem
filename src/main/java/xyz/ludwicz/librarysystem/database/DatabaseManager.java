...
public class DatabaseManager {
    ...
    private SQLTaskProcessor taskProcessor;
    ...
    public DatabaseManager() throws HikariPool.PoolInitializationException {
        try {
            ...
            JOptionPane.showMessageDialog(null, "MySQL 서버에 연결할 수 없습니다.\n처음 실행하신다면 config.json을 설정해 주세요.", "경고", JOptionPane.WARNING_MESSAGE);
            System.exit(1);
        }
    }
